...
local defaults = {
    ...
    auras = {
        ...
        -- All raid buffs use hide_when_healthy with refresh_warn = 600 (10 min)
        {
            ...
            spell_id = 48470,  -- Gift of the Wild Rank 3
            show_missing = true,
            refresh_warn = 600,
        ...
        },
        {
            ...
            spell_id = 42995,  -- Arcane Brilliance Rank 2
            show_missing = true,
            refresh_warn = 600,
            hide_when_healthy = true,
            in_raid_only = true,
        ...
        },
        {
            ...
            spell_id = 25898,  -- Greater Blessing of Kings
            show_missing = true,
            refresh_warn = 600,
            hide_when_healthy = true,
            in_raid_only = true,
        ...
        },
        {
            ...
            spell_id = 48938,  -- Greater Blessing of Wisdom Rank 4
            show_missing = true,
            refresh_warn = 600,
            hide_when_healthy = true,
            in_raid_only = true,
        ...
        },
        {
            ...
            spell_id = 25899,  -- Greater Blessing of Sanctuary
            show_missing = true,
            refresh_warn = 600,
            hide_when_healthy = true,
            in_raid_only = true,
        ...
        },
        {
            ...
            spell_id = 48074,  -- Prayer of Spirit Rank 2
            show_missing = true,
            refresh_warn = 600,
            hide_when_healthy = true,
            in_raid_only = true,
        ...
        },
        {
            ...
            spell_id = 48162,  -- Prayer of Fortitude Rank 3
            show_missing = true,
            refresh_warn = 600,
            hide_when_healthy = true,
            in_raid_only = true,
        ...
        },
        {
            ...
            spell_id = 53755,  -- Flask of the Frost Wyrm
            show_missing = true,
            refresh_warn = 600,
            hide_when_healthy = true,
            in_raid_only = true,
        ...
        },
        {
            ...
            type = "buff",
            spell = "Well Fed",
            spell_id = 57139,  -- Well Fed (Fish Feast)
            show_missing = true,
            refresh_warn = 600,
            hide_when_healthy = true,
            in_raid_only = true,
